...
<head>
  ...
  <style>
    ...
    .sidebar .nav-link {
      margin-bottom: 1rem; /* Add spacing between nav links */
    }
  ...
  <main class="d-flex flex-nowrap" style="height: 100svh">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="applicant.php" class="nav-link active" aria-current="page">
    ...
    <div class="container w-75">
      <h1 class="display-3 text-center">Applicant</h1>
      <table class="table table-striped">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>1912-06-23</td>
            <td>789 Birch St, Springfield</td>
            <td>SPED</td>
          </tr>
          <tr>
            <td>4</td>
            ...
            <td>1815-12-10</td>
            <td>101 Maple St, Springfield</td>
            <td>Mathematics</td>
          </tr>
        </tbody>
      </table>
